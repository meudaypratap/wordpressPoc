...
<div id="comments">
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php wp_list_comments( array( 'callback' => 'puja_comment' ) ); ?>
		</ol>

		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // are there comments to navigate through ?>
		<nav id="comment-nav-below">
			<h1 class="assistive-text"><?php _e( 'Comment navigation', 'dussehra' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( 'Older <span>Comments</span>', 'dussehra' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer <span>Comments</span>', 'dussehra' ) ); ?></div>
		</nav>
		<?php endif; // check for comment navigation ?>
	...
	<?php
		...
		?>
		<p class="nocomments"><?php _e( 'Comments are closed.', 'dussehra' ); ?></p>
