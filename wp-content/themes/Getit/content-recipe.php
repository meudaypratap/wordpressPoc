        ...
        <div id="leftPanel">
            <div class="content-box">
                <div id="breadcrumb"><a href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/">Home</a>
                    <img src="http://<?php echo $_SERVER['HTTP_HOST'] ?>/images/arrow.jpg" align="absmiddle"/>
                    <a href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/blog/">Blogs</a>
                    <img src="http://<?php echo $_SERVER['HTTP_HOST'] ?>/images/arrow.jpg" align="absmiddle"/>
                    <?php the_title(); ?>
                    <span class="register">&nbsp;|&nbsp;<a href="wp-login.php?action=register" target="_blank">Register</a></span>
                    <span class="register"><a href="wp-admin/" target="_blank">Login</a></span>
                </div>
                <!--    <div id="inner-banner">-->
                <!--        <img src="http://--><?php //echo $_SERVER['HTTP_HOST'] ?><!--/images/puja-aboutus-pic.jpg"/>-->
                <!--    </div>-->
